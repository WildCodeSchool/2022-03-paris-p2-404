...
export const IslesAndRiversUsersList = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="">Isles and Rivers' users</h2>
      </div>
      ...
      <div className="my-8">
        {characters
          .filter(
            (character) =>
              character.firstName.includes('Melisandre')||
              character.firstName.includes('Euron')||
              character.firstName.includes('Yara')||
              character.firstName.includes('Theon')
          )
