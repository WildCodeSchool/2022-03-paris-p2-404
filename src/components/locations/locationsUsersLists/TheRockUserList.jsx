  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="">The Rock's users</h2>
      </div>
      ...
      <div className="my-8">
        {characters
          .filter(
            (character) =>
              character.firstName.includes('Tywin') ||
              character.firstName.includes('Jaqen') ||
              character.firstName.includes('Gendry')
          )
