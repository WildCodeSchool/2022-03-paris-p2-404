...
export const MountainAndValeUserList = () => {
    ...
    >
      ...
      <div className="my-8">
        {characters
          .filter(
            (character) =>
              character.firstName.includes('Lord') ||
              character.firstName.includes('Arya') ||
              character.firstName.includes('Sandor') ||
              character.firstName.includes('Petyr'))
