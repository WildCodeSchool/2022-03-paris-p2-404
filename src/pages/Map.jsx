...
import thegreatnorthmap from '../assets/img/thegreatnorthmap.png';
import thenorthmap from '../assets/img/thenorthmap.png';
import map_mountains from '../assets/img/map_mountains.png';
import map_rivers from '../assets/img/map_rivers.png';
import map_rock from '../assets/img/map_rock.png';
...
{isVisible9 && (
      ...
      grid grid-cols-2 grid-rows-9
    m-4 lg:m-16 lg:mx-48 h-full items-center justify-center
      shadow-slate-700"
      >
        <h2 className="countries m-4 text-center wrap lg:text-xl">The Great North</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible}
            className="greatnorth  w-full h-full cursor-pointer transition-all"
            alt="#"
            src={thegreatnorthmap}
          ></img>
        </div>

        <h2 className="countries m-4 text-center lg:text-xl">The North</h2>
        <div className=" m-2 mx-4 hover:scale-105  transition-all  ">
          <img
            onClick={handleVisible2}
        ...
        <h2 className="countries m-4 text-center lg:text-xl">Mountain and the vale</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible3}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">Isles and the Rivers</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible4}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">The rock</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible5}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">Stormlands</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible6}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">The reach</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
            onClick={handleVisible7}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">Dorne</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
          onClick={handleVisible8}
            className="greatnorth  w-full h-full cursor-pointer"
        ...
        <h2 className="countries m-4 text-center lg:text-xl">King's Landing</h2>
        <div className=" m-2 mx-4 hover:scale-105 transition-all  ">
          <img
          onClick={handleVisible9}
            className="greatnorth  w-full h-full cursor-pointer"
